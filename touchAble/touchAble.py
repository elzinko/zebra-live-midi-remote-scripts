...
class touchAble(ControlSurface):
    ...
    def sendScriptPong(self):
        ...
        self.oscServer.sendOSCUDP("/script/pong", (417, int(xx), int(a), int(b), int(c),int(self.listeners_updated),int(self.received_midi_cmd)))
    ...
    def getStatus(self, msg):   
        ...
        self.oscServer.sendOSC("/script/pong", (417, int(xx), int(a), int(b), int(c),int(self.listeners_updated),int(self.received_midi_cmd)))
